...
published:
clipped: 2026-06-19
description: "Self-hosted AI workspace. . Contribute to pewdiepie-archdaemon/odysseus development by creating an account on GitHub."
domain: "github.com"
tags:
  - "source"
  - "clipping"
...
[![Odysseus](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/odysseus.jpg)](https://github.com/pewdiepie-archdaemon/odysseus/blob/dev/docs/odysseus.jpg)
...
- **Chat** -- chat with any local model or API; adding them is super simple.  
	　 <sub>vLLM · llama.cpp · Ollama · OpenRouter · OpenAI · GitHub Copilot</sub>
- **Agent** -- hand it tools and let it run the whole task itself.  
	　 <sub>built on <a href="https://github.com/anomalyco/opencode">opencode</a> · MCP · web · files · shell · skills · memory</sub>
- **Cookbook** -- Scans your hardware, recommends models, click to download and serve.. easy!  
	　 <sub>built on <a href="https://github.com/AlexsJones/llmfit">llmfit</a> · VRAM-aware · GGUF / FP8 / AWQ · fit scoring · vLLM / llama.cpp serving</sub>
- **Deep Research** -- multi-step runs that gather, read, and synthesize sources into a nice visual report.  
	　 <sub>adapted from <a href="https://github.com/Alibaba-NLP/DeepResearch">Tongyi DeepResearch</a></sub>
- **Compare** -- a fun tool to compare models side by side. Test completely blind, no bias!  
	　 <sub>multi-model · blind test · synthesis</sub>
- **Documents** -- YOU write the text, AI is there to assist, not the opposite.  
	　 <sub>multi-tab editor · markdown · HTML · CSV · syntax highlighting · AI edits · suggestions</sub>
- **Memory / Skills** -- Persistent memory and skills, your agent evolves over time as it better understands you and your tasks!  
	　 <sub>ChromaDB · fastembed (ONNX) · vector + keyword retrieval · import/export</sub>
- **Email** -- IMAP/SMTP inbox with AI triage built in: urgency reminders, auto-tag, auto-summary, auto-reply drafts, auto-spam.  
	　 <sub>IMAP · SMTP · per-account routing · CalDAV-aware</sub>
- **Notes & Tasks** -- Quick notes with reminders, a todo list, and scheduled tasks the agent can act on.  
	　 <sub>note pings · checklist · cron-style tasks · ntfy / browser / email channels</sub>
- **Calendar** -- Local-first calendar with CalDAV sync to Radicale / Nextcloud / Apple / Fastmail.  
	　 <sub>CalDAV pull ·.ics import/export · per-calendar colors · agent-aware</sub>
- **Works on mobile** -- looks and runs great on your phone, not just desktop.  
	　 <sub>responsive · installable (PWA) · touch gestures</sub>
- **Extras** -- more to explore, happy if you give it a go!  
	　 <sub>image editor · theme editor · file uploads (vision + PDF) · web search · presets · sessions · 2FA</sub>
...
![Chat & Agents](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/chat.gif)

Chat & Agents

### Deep Research

![Deep Research](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/research.gif)

Deep Research

### Compare

![Compare](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/compare.gif)

### Documents

![Documents](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/document.gif)

### Notes & Tasks

![Notes & Tasks](https://github.com/pewdiepie-archdaemon/odysseus/raw/dev/docs/notes.gif)
...
Contributing? See [CONTRIBUTING.md](https://github.com/pewdiepie-archdaemon/odysseus/blob/dev/CONTRIBUTING.md) for setup, testing, and pull request guidelines.
...
Help is welcome. The best entry points are fresh-install testing, provider setup bugs, mobile/editor polish, docs, and small focused refactors. See [ROADMAP.md](https://github.com/pewdiepie-archdaemon/odysseus/blob/dev/ROADMAP.md) for the current help-wanted list.
...
![Star History Chart](https://camo.githubusercontent.)

](https://www.star-history.com/?repos=pewdiepie-archdaemon%2Fodysseus&type=date&legend=top-left)

## License

MIT -- see [LICENSE](https://github.com/pewdiepie-archdaemon/odysseus/blob/dev/LICENSE) and [ACKNOWLEDGMENTS.md](https://github.com/pewdiepie-archdaemon/odysseus/blob/dev/ACKNOWLEDGMENTS.md).
